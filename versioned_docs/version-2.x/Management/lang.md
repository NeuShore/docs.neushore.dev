  ...
  Embeds:
    - Author: "{brand-name}"
      ...
      Fields:
        ...
        - Name: ⚡ Blazing fast!
          Value:
            "> No unnecessary packages or dependencies! Doesn't get any more
            lightweight."
        - Name: ⚙ Easy to Customize
          Value: "> Every message is customizable. Change them all you want!"
        - Name: 💻 Cross-Platform
          Value:
            "> ARM, Linux, MacOS, Windows... Inside Docker or on Pterodactyl. We
            support all of them!"
      Footer: "{user-tag}"
      Timestamp: true
General:
    ...
    InvalidUsage:
      Embeds:
        - Author: "{brand-name} | Invalid Usage"
          AuthorIcon: "{brand-logo}"
          Description:
            "> {user-mention}, you have to specify a valid type of information
    ...
    BotInfo:
      Embeds:
        - Author: "{brand-name}"
          AuthorIcon: "{brand-logo}"
          Description:
            "> BrayanBot is a modern Discord bot written with latest DiscordJS
    ...
    NoCommandsInCategory:
      Embeds:
        - Author: "{brand-name} | List Category"
          AuthorIcon: "{brand-logo}"
          Description:
            "> {user-mention}, the category you are looking for does not have
            any commands."
          FooterIcon: "{user-pfp}"
          Footer: "{user-tag}"
          Timestamp: true
  ...
  CommandOnCooldown:
    ...
    Embeds:
      - Author: "{brand-name} • Command Cooldown"
        Description:
          "> You are on cooldown for this command. You'll be able to use this
          command in <t:{time}:R>."
        AuthorIcon: "{brand-logo}"
        FooterIcon: "{user-pfp}"
        Footer: "{user-tag}"
