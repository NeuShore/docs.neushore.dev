...
```diff title="updated commands.yml"
          - Type: "User"
            Name: "target"
            Name: "target"
...
2. Add the new **admin** section as well as the necessary lines for the **eval command** into your **`commands.yml`**, starting with **line 89**
